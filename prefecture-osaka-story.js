// 和酒ログ 大阪府ストーリースクロール
// 「まとまらない。それが、大阪。」を体験にする。太陽の塔→ネオン→新世界→食→だんじり→酒。
(function(){
